...
#### First define our directories. This is the 500 length segments, change the number to load in the other segments.

#Note THESE ARE THE LOCATIONS  OF THE FILES ON MY LAPTOl, NOT YOURS. You will need to edit these to reflect whwere you have downloaded the files

functionwords <- readLines("~/Desktop/SCS Final Project/wordfile200 (1).txt") #function word list
humantexts <- loadCorpusText("~/Desktop/SCS Final Project/essays/human/")
...
#
#on my lapto this takes around 10 minutes (each count is up to 110 since there are 110 topic folders)
