...
# Convert texts into long vector of words in all texts
...
cat("==============================\n")
cat("False positive rate (Human -> GPT):", round(project_results$false_positive_rate, 4), "\n")
cat("True positive rate  (Mixed -> GPT):", round(project_results$true_positive_rate, 4), "\n")
cat("AUROC:", round(project_results$auc_value, 4), "\n\n")
print(project_results$confusion_mat)

cat("\n==============================\n")
cat("LOCALISATION RESULTS\n")
cat("==============================\n")
cat("Mean |tau1 - tau1_hat|:", round(project_results$mean_err_c1, 2), "\n")
cat("Mean |tau2 - tau2_hat|:", round(project_results$mean_err_c2, 2), "\n")
cat("Median |tau1 - tau1_hat|:", round(project_results$median_err_c1, 2), "\n")
cat("Median |tau2 - tau2_hat|:", round(project_results$median_err_c2, 2), "\n")
